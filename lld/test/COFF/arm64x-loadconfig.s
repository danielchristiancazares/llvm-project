...
// RUN:           2>&1 | FileCheck --check-prefix=WARN-LOADCFG --implicit-check-not EC %s
...
// RUN:           2>&1 | FileCheck --allow-empty --check-prefix=NO-LOADCFG %s
// NO-LOADCFG-NOT: _load_config_used
